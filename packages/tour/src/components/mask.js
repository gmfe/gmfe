...
export default function SVGMask({
  ...
  const width = util.safe(targetWidth + padding * 2)
  const height = util.safe(targetHeight + padding * 2)
  const top = util.safe(targetTop - padding)
  const left = util.safe(targetLeft - padding)
        ...
        <defs>
          ...
          <clipPath id='clip-path'>
            ...
            <rect
              ...
              y={top}
              width={util.safe(windowWidth - targetWidth - left)}
              height={height}
            />
            {/* bottom */}
            <rect
              ...
              width={windowWidth}
              height={util.safe(windowHeight - targetHeight - top)}
            />
          </clipPath>
        </defs>
        <rect
