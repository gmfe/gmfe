...
const DiyTableModal = ({
  ...
  return (
    <div className='gm-react-table-diy-modal gm-react-table-diy-modal-fit' ref={rootRef}>
      <Flex
      ...
      <Flex justifyBetween className='gm-react-table-diy-modal-btn gm-padding-10'>
