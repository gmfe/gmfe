...
interface BaseTableColumns<Original extends { [key: string]: unknown }> {
  Header:
    | ReactNode
    | ((row: {
...
interface BaseTableProps<Original extends { [key: string]: unknown }> {
  loading?: boolean
  data: Original[]
  columns: BaseTableColumns<Original>
  className?: string
...
> extends Component<BaseTableProps<Original>, void> {}
