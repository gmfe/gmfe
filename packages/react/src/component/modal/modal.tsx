...
class Modal extends Component<ModalProps> {
  ...
  static render(props: PropsWithChildren<Partial<ModalProps>>): void {
    ...
    LayoutRoot.setComponent(
      ...
      <Modal show onHide={handleHide} {...rest} />
    )
  }
  ...
  componentDidMount() {
    ...
    if (this.props.show) {
      this._modalRef.current!.addEventListener(
        // todo
        'scroll',
        _.throttle(this._doScroll, 200)
      )
    }
  }
  ...
  componentWillUnmount() {
    ...
    this._modalRef.current!.removeEventListener('scroll', this._doScroll) // todo
  }
